...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plyr_chaining3-1.png" width="672" />
...
```
    ...
    ## 1  id104          6.3         2.9          5.6         1.8  virginica
    ## 2  id135          6.1         2.6          5.6         1.4  virginica
    ## 3   id49          5.3         3.7          1.5         0.2     setosa
    ## 4   id37          5.5         3.5          1.3         0.2     setosa
    ## 5  id139          6.0         3.0          4.8         1.8  virginica
    ## 6  id133          6.4         2.8          5.6         2.2  virginica
    ## 7   id52          6.4         3.2          4.5         1.5 versicolor
    ## 8    id6          5.4         3.9          1.7         0.4     setosa
    ## 9   id40          5.1         3.4          1.5         0.2     setosa
    ## 10  id74          6.1         2.8          4.7         1.2 versicolor
...
```
    ...
    ## 4   id49          5.3         3.7          1.5         0.2     setosa  id49          5.3
    ## 5   id52          6.4         3.2          4.5         1.5 versicolor  id52          6.4
    ## 6   id74          6.1         2.8          4.7         1.2 versicolor  id74          6.1
    ## 7  id104          6.3         2.9          5.6         1.8  virginica id104          6.3
    ## 8  id133          6.4         2.8          5.6         2.2  virginica id133          6.4
    ## 9  id135          6.1         2.6          5.6         1.4  virginica id135          6.1
    ## 10 id139          6.0         3.0          4.8         1.8  virginica id139          6.0
    ##    Sepal.Width Petal.Length Petal.Width    Species
    ## 1          3.9          1.7         0.4     setosa
    ## 2          3.5          1.3         0.2     setosa
    ## 3          3.4          1.5         0.2     setosa
    ## 4          3.7          1.5         0.2     setosa
    ## 5          3.2          4.5         1.5 versicolor
    ## 6          2.8          4.7         1.2 versicolor
    ## 7          2.9          5.6         1.8  virginica
    ## 8          2.8          5.6         2.2  virginica
    ## 9          2.6          5.6         1.4  virginica
    ## 10         3.0          4.8         1.8  virginica
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/basic_scatter_plot-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/pairs_scatter_plot-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/labels_scatter_plot-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/row_scatter_plot-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_regression-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_regression_log-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_regression_math-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_line_single-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_line_many-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_bar_simple-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_bar_error-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_hist-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_dens-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_pie-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/plot_example-1.png" width="672" />
...
<img src="/en/rmarkdown/tutorials/rbasics/Rbasics_files/figure-html/some_jitter_plot-1.png" width="672" />
