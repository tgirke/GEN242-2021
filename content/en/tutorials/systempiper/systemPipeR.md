...
syntax for naming samples and replicates. In addition, to avoid problems with other
packages or external software, it is recommended to use the basic naming rules
for R objects as outlined [here](https://girke.bioinformatics.ucr.edu/GEN242/tutorials/rbasics/rbasics/#data-objects).
