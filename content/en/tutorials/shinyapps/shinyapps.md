...
The following introduces the basic development routines for Shiny apps using the RStudio IDE. Most other development
for R environments can be used here as well. For beginners the interactive test and debugging functionalities of
