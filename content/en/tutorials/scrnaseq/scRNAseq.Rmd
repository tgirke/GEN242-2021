...
RNA-Seq (scRNA-Seq) data [@Duo2018-oo].  Many dimensionality reduction methods
...
[@McInnes2018-tc]. In addition, some packages, such as the Bioconductor
...
intesively tested by several studies, including Sun et al. [-@Sun2019-po;
-@Sun2020-ct].
