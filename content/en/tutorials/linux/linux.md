...
1. Log in to your user account on HPCC and execute `Install_Nvim-R_Tmux`. Alternatively, follow these step-by-step [install commands](https://github.com/tgirke/Install_Nvim-R_Tmux).
