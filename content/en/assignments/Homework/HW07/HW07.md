...
Note, for Tasks 1-3 only the code and/or text needs to be included in the homework submission. For details see below.
...
Note, for Tasks 4 only include the code and/or text in your homework submission. For details see below.
...
Note, for Tasks 5 include both the code and the resulting image in your homework submission. For deteails see below.
