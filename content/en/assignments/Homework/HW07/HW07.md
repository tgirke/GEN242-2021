...
Accept the homework on [Github Classroom](https://classroom.github.com/a/yO-N0WRj), and follow the instructions in the `README.md` file.

Please submit the homework results in one well structured and annotated R script to GitHub classroom.
