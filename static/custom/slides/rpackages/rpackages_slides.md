...
- Newer Package Build Environment
- References
...
- Overview
- <div class="white">__Traditional Approach__</div>
- Newer Package Build Environment
- References
...
- Overview
- Traditional Approach
- <div class="white">__Newer Package Build Environment__</div>
- References

## With `devtools`, `usethis`, `roxygen2` and `sinew`
